...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_PAINT:
        ...
        hBrush = CreateSolidBrush(RGB(55, 206, 235)); 
        ...
        hBrush = CreateSolidBrush(RGB(102, 51, 0)); // Цвет меха
        SelectObject(hdc, hBrush);
        ...
        // Уши
        Ellipse(hdc, 225, 110, 275, 175);
        Ellipse(hdc, 325, 110, 375, 175);
        ...
        SelectObject(hdc, hBrush);
        Ellipse(hdc, 370, 380, 430, 430);

        // Надпись
        SetTextColor(hdc, RGB(0, 0, 0));
        SetBkMode(hdc, TRANSPARENT);
        TextOut(hdc, 380, 395, TEXT("МЁД"), 5);
